...
try:
    ...
    pricet4bHPEL9 = pricet4bHPEL9_2[1]
    ...
    pricet4bQTML9 = pricet4bQTML9_2[1]
    ...
    pricet4bIBML9 = pricet4bIBML9_2[1]
...
if __name__ == "__main__":
    import datetime
    writer = pd.ExcelWriter("internet_pricing_LTO9_{}.xlsx".format(pd.Timestamp.now().strftime("%Y-%m-%d")))
